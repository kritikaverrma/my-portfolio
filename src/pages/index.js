...
export default function Home() {
  ...
  return (
    <Layout>
      <main className="bg-zinc-900 text-white font-sans scroll-smooth flex flex-col justify-center items-center gap-3">
        ...
        <section id="hero" className="min-h-screen flex flex-col justify-center items-center text-center px-6">
          ...
          <p className="text-gray-300">
            I'm a passionate full-stack developer who loves building fast, functional, and visually striking web apps. From creating secure backend APIs to crafting intuitive frontends, I focus on delivering clean code and great user experiences. I enjoy solving real-world problems through technology and constantly learning new tools. Let’s build something awesome together.
